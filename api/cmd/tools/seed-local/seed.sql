...
INSERT INTO games (id, source_type, created_by_user_id, title, description, starts_at, ends_at, venue_id, capacity, minimum_skill_level, maximum_skill_level, visibility, status, waitlist_enabled, waitlist_size)
VALUES
 ('60000000-0000-0000-0000-000000000001', 'manual', '10000000-0000-0000-0000-000000000001', 'Sábado na Praia do Sol', 'Jogo aberto para nível iniciante a avançado.', '2026-08-01 09:00:00-03', '2026-08-01 10:30:00-03', '20000000-0000-0000-0000-000000000101', 4, 'beginner', 'advanced', 'public', 'scheduled', true, 1),
 ('60000000-0000-0000-0000-000000000002', 'manual', '10000000-0000-0000-0000-000000000002', 'Treino Arena Copacabana', 'Treino competitivo; confirme presença.', '2026-08-02 10:00:00-03', '2026-08-02 12:00:00-03', '20000000-0000-0000-0000-000000000102', 6, 'intermediate', 'competitive', 'link-only', 'scheduled', true, 1),
